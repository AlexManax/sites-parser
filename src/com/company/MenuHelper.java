...
public class MenuHelper {
    ...
    public static void initColorMenu(View view, JMenuBar menuBar) {
        ...
        addMenuItem(colorMenu, new StyledEditorKit.ForegroundAction("Rad", Color.red));
    ...
    public static void initStyleMenu(View view, JMenuBar menuBar) {
        JMenu styleMenu = new JMenu("Stile");
        ...
        addMenuItem(styleMenu, "Crossed", new StrikeThroughAction());
